...
For the Rails portion (the api), SQLite was the db used in development by default but Postgres had to be used for production to play well with Heroku. I deployed the React portion (the UI) to Firebase. You can see the final project [here](https://ideaboard-rails-react.firebaseapp.com/).
